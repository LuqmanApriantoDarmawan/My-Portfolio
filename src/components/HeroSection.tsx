        ...
        <div className="animate-fade-in max-w-4xl mx-auto">
          ...
          <div className="mb-8 relative inline-block">
            <div className="relative">
              <img 
                src={profileImage} 
                alt="Luqman Profile" 
                className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover mx-auto border-4 border-primary/30 shadow-glow"
              />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              size="lg"
              className="bg-gradient-teal hover:shadow-glow transition-all duration-300 transform hover:scale-105 text-base px-8 py-6 min-w-[140px]"
            >
              View My Work
            </Button>
            <Button 
              ...
              variant="outline"
              size="lg"
              className="border-border hover:bg-accent hover:text-accent-foreground transition-all duration-300 text-base px-8 py-6 min-w-[140px]"
            >
              Contact Me
            </Button>
          </div>
